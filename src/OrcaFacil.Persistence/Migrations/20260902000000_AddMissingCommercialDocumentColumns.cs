...
/// <summary>Repairs installations created before the commercial document fields were introduced.</summary>
[DbContext(typeof(OrcaFacilDbContext))]
[Migration("20260902000000_AddMissingCommercialDocumentColumns")]
public partial class AddMissingCommercialDocumentColumns : Migration
{
...
""");
    ...
    // Deliberately empty: rollback must not destroy customer data from pre-existing columns.
