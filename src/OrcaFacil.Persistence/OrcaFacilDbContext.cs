...
public class OrcaFacilDbContext : DbContext
{
    ...
    public DbSet<SupportCsatSurvey> SupportCsatSurveys => Set<SupportCsatSurvey>();
    public DbSet<SupportCsatResponse> SupportCsatResponses => Set<SupportCsatResponse>();
    public DbSet<SupportIncident> SupportIncidents => Set<SupportIncident>();
    public DbSet<SupportIncidentImpactedAccount> SupportIncidentImpactedAccounts => Set<SupportIncidentImpactedAccount>();
    public DbSet<SupportProblemRecord> SupportProblemRecords => Set<SupportProblemRecord>();
