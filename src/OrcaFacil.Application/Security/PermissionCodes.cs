...
public static class PermissionCodes
{
    ...
    public const string DataQualityRulesView = "DataQuality.RulesView";
    public const string DataQualityRulesManage = "DataQuality.RulesManage";
    public const string DataQualityFindingsView = "DataQuality.FindingsView";
    public const string DataQualityResolveFindings = "DataQuality.ResolveFindings";
    public const string DataQualityDuplicatesView = "DataQuality.DuplicatesView";
    public const string DataQualityMerge = "DataQuality.Merge";
    public const string DataQualityNormalize = "DataQuality.Normalize";
    public const string DataImportView = "DataImport.View";
    public const string DataImportManage = "DataImport.Manage";
    public const string DataImportCommit = "DataImport.Commit";
    public const string DataImportRollback = "DataImport.Rollback";
    public const string DataIntegrityView = "DataIntegrity.View";
    public const string SensitiveDataReviewView = "SensitiveDataReview.View";
    public const string SensitiveDataReviewManage = "SensitiveDataReview.Manage";
    public const string DataQualityReportsView = "DataQuality.ReportsView";
    public const string DataQualityExport = "DataQuality.Export";
