...
for (const check of ['check:js-safety', 'check:public-navigation', 'check:authenticated-navigation', 'check:routes', 'check:razor-pages', 'check:open-features', 'check:design-consistency', 'check:persona-flows']) {
